...
exports.runAllExamples = exports.example8_ErrorRecovery = exports.example7_PerformanceMonitoring = exports.example6_CognitiveOptimization = exports.example5_VariantGeneration = exports.example4_TemplateValidation = exports.example3_BatchExport = exports.example2_AdvancedExport = exports.example1_QuickExport = void 0;
 ...
 */
async function example1_QuickExport() {
    console.log('🚀 Example 1: Quick Export');
    try {
        const result = await (0, index_1.quickExport)(exampleTemplate, './exports/quick', 'json');
...
exports.example2_AdvancedExport = example2_AdvancedExport;
/**
 * Example 3: Batch Export - Multiple templates in parallel
 */
async function example3_BatchExport() {
    ...
    try {
        ...
        const results = await (0, index_1.batchExport)(templates, './exports/batch', 'json');
...
exports.example3_BatchExport = example3_BatchExport;
/**
 * Example 4: Template Validation - Standalone validation with detailed reporting
 */
async function example4_TemplateValidation() {
    console.log('🚀 Example 4: Comprehensive Template Validation');
    try {
        // Validate with strict mode
        const strictValidation = await (0, index_1.validateTemplate)(exampleTemplate, true);
        ...
        const lenientValidation = await (0, index_1.validateTemplate)(exampleTemplate, false);
...
exports.example4_TemplateValidation = example4_TemplateValidation;
/**
 * Example 5: Variant Generation - Generate all template variants
 */
async function example5_VariantGeneration() {
    console.log('🚀 Example 5: Template Variant Generation');
    try {
        // Generate all variants
        const allVariantsResult = await (0, index_1.generateVariants)(exampleTemplate);
        ...
        const specificVariantsResult = await (0, index_1.generateVariants)(exampleTemplate, [
...
exports.example5_VariantGeneration = example5_VariantGeneration;
/**
 * Example 6: Cognitive Optimization - Template export with cognitive consciousness
 */
async function example6_CognitiveOptimization() {
...
exports.example6_CognitiveOptimization = example6_CognitiveOptimization;
/**
...
async function example7_PerformanceMonitoring() {
    ...
    try {
        ...
        const exportPromises = Array(10).fill(null).map((_, index) => exporter.exportTemplate({
            ...exampleTemplate,
...
exports.example7_PerformanceMonitoring = example7_PerformanceMonitoring;
/**
    ...
    try {
        ...
        const invalidTemplate = {
            ...
            meta: {
                ...
                templateId: 'invalid-template-name!',
        ...
        const validator = new index_1.ExportValidator({
            strictMode: true,
            enableLearning: true,
            enableAutoFix: true,
            maxAutoFixes: 5,
...
exports.example8_ErrorRecovery = example8_ErrorRecovery;
/**
 * Run all examples
 */
