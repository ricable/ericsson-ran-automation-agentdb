...
exports.runAllExamples = exports.example4_RealTimeMonitoring = exports.example3_PreviewValidationMode = exports.example2_AdvancedMultiTechnology = exports.example1_BasicBatchOperation = void 0;
const BatchOperationsManager_1 = require("../core/BatchOperationsManager");
/**
 * Example 1: Basic Batch Operation with Simple Pattern Matching
 */
async function example1_BasicBatchOperation() {
    console.log('\n=== Example 1: Basic Batch Operation ===');
    // Create batch operations manager
    const batchManager = new BatchOperationsManager_1.BatchOperationsManager();
...
exports.example1_BasicBatchOperation = example1_BasicBatchOperation;
/**
 * Example 2: Advanced Multi-Technology Configuration
 */
async function example2_AdvancedMultiTechnology() {
    console.log('\n=== Example 2: Advanced Multi-Technology Configuration ===');
    const batchManager = new BatchOperationsManager_1.BatchOperationsManager();
...
exports.example2_AdvancedMultiTechnology = example2_AdvancedMultiTechnology;
/**
 * Example 3: Preview and Validation Mode
 */
async function example3_PreviewValidationMode() {
    console.log('\n=== Example 3: Preview and Validation Mode ===');
    const batchManager = new BatchOperationsManager_1.BatchOperationsManager();
    const config = {
...
exports.example3_PreviewValidationMode = example3_PreviewValidationMode;
/**
...
exports.example4_RealTimeMonitoring = example4_RealTimeMonitoring;
/**
...
exports.default = runAllExamples;
//# sourceMappingURL=BatchOperationsExample.js.map