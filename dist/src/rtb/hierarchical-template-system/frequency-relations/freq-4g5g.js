...
exports.calculate4G5GMetrics = exports.supportsHighMobility = exports.isLowFrequencyBand = exports.isHighCapacityBand = exports.isValidENDCCombination = exports.FREQ_4G5G_TEMPLATES = exports.ENTERPRISE_ENDC_TEMPLATE = exports.MOBILITY_ENDC_TEMPLATE = exports.COVERAGE_ENDC_TEMPLATE = exports.HIGH_PERFORMANCE_ENDC_TEMPLATE = exports.STANDARD_ENDC_TEMPLATE = exports.CROSS_TECH_INTERFERENCE_SETTINGS = exports.ENDC_CAPACITY_SHARING = exports.CONSERVATIVE_ENDC_HANDOVER = exports.AGGRESSIVE_ENDC_HANDOVER = exports.STANDARD_ENDC_HANDOVER = exports.NR_BANDS = void 0;
/**
 ...
 */
exports.STANDARD_ENDC_HANDOVER = {
    triggerType: 'B1',
    hysteresis: 2,
    timeToTrigger: 320,
 ...
 */
exports.AGGRESSIVE_ENDC_HANDOVER = {
    triggerType: 'B1',
    hysteresis: 1,
    timeToTrigger: 160,
 ...
 */
exports.CONSERVATIVE_ENDC_HANDOVER = {
    triggerType: 'B1',
    hysteresis: 4,
    timeToTrigger: 640,
    cellIndividualOffset: 0,
 ...
 */
exports.CROSS_TECH_INTERFERENCE_SETTINGS = {
    enabled: true,
 ...
 */
function createBase4G5GRelation(relationId, referenceBand, relatedBand, priority = 60) {
    return {
        relationId,
 ...
 */
exports.STANDARD_ENDC_TEMPLATE = {
    ...
    templateType: '4G5G',
    priority: 60,
    baseConfig: createBase4G5GRelation('4G5G_STANDARD', { bandNumber: 3, frequencyRange: { uplink: { start: 1710, end: 1785 }, downlink: { start: 1805, end: 1880 } }, bandCategory: 'LTE', primaryUse: 'CAPACITY' }, exports.NR_BANDS[78]),
    parameters: [
        {
            name: 'lteBand',
            type: 'INTEGER',
 ...
 */
exports.HIGH_PERFORMANCE_ENDC_TEMPLATE = {
    ...
    templateType: '4G5G',
    priority: 60,
    baseConfig: Object.assign(createBase4G5GRelation('4G5G_PERF', { bandNumber: 7, frequencyRange: { uplink: { start: 2500, end: 2570 }, downlink: { start: 2620, end: 2690 } }, bandCategory: 'LTE', primaryUse: 'CAPACITY' }, exports.NR_BANDS[78]), {
        handoverConfig: exports.AGGRESSIVE_ENDC_HANDOVER,
        capacitySharing: exports.ENDC_CAPACITY_SHARING,
        endcConfig: {
            meNbConfig: {
                splitBearerSupport: true,
                dualConnectivitySupport: true,
 ...
 */
exports.COVERAGE_ENDC_TEMPLATE = {
    ...
    templateType: '4G5G',
    priority: 60,
    baseConfig: Object.assign(createBase4G5GRelation('4G5G_COV', { bandNumber: 20, frequencyRange: { uplink: { start: 832, end: 862 }, downlink: { start: 791, end: 821 } }, bandCategory: 'LTE', primaryUse: 'COVERAGE' }, exports.NR_BANDS[78]), {
        handoverConfig: exports.CONSERVATIVE_ENDC_HANDOVER
    }),
    parameters: [
        {
 ...
 */
exports.MOBILITY_ENDC_TEMPLATE = {
    ...
    templateType: '4G5G',
    priority: 60,
    baseConfig: Object.assign(createBase4G5GRelation('4G5G_MOB', { bandNumber: 3, frequencyRange: { uplink: { start: 1710, end: 1785 }, downlink: { start: 1805, end: 1880 } }, bandCategory: 'LTE', primaryUse: 'CAPACITY' }, exports.NR_BANDS[41]), {
        handoverConfig: exports.AGGRESSIVE_ENDC_HANDOVER,
        interferenceConfig: exports.CROSS_TECH_INTERFERENCE_SETTINGS
    }),
    parameters: [
        {
 ...
 */
exports.ENTERPRISE_ENDC_TEMPLATE = {
    ...
    templateType: '4G5G',
    priority: 60,
    baseConfig: Object.assign(createBase4G5GRelation('4G5G_ENT', { bandNumber: 78, frequencyRange: { uplink: { start: 3300, end: 3800 }, downlink: { start: 3300, end: 3800 } }, bandCategory: 'NR', primaryUse: 'HOTSPOT' }, { bandNumber: 1, frequencyRange: { uplink: { start: 1920, end: 1980 }, downlink: { start: 2110, end: 2170 } }, bandCategory: 'LTE', primaryUse: 'HOTSPOT' }), {
        handoverConfig: exports.CONSERVATIVE_ENDC_HANDOVER,
        capacitySharing: {
            enabled: true,
            strategy: 'PRIORITY_BASED',
 ...
 */
function isValidENDCCombination(lteBand, nrBand) {
    ...
    return validENDCCombinations.some(combination => combination.lte === lteBand && combination.nr.includes(nrBand));
}
exports.isValidENDCCombination = isValidENDCCombination;
/**
 * Check if band is high capacity
 */
function isHighCapacityBand(band) {
    const highCapacityBands = [1, 3, 7, 41, 77, 78];
    return highCapacityBands.includes(band);
}
exports.isHighCapacityBand = isHighCapacityBand;
/**
 * Check if band is low frequency
 */
function isLowFrequencyBand(band) {
    const lowFrequencyBands = [20, 28, 71];
    return lowFrequencyBands.includes(band);
}
exports.isLowFrequencyBand = isLowFrequencyBand;
/**
 * Check if band supports high mobility scenarios
 */
function supportsHighMobility(band) {
    const highMobilityBands = [1, 3, 7, 41, 77, 78];
    return highMobilityBands.includes(band);
}
exports.supportsHighMobility = supportsHighMobility;
/**
 * Calculate 4G5G frequency relation performance metrics
 */
function calculate4G5GMetrics(config) {
...
exports.calculate4G5GMetrics = calculate4G5GMetrics;
//# sourceMappingURL=freq-4g5g.js.map