...
exports.calculate5G5GMetrics = exports.getMaxSupportedBandwidth = exports.areHighCapacityBands = exports.supportsMassiveMimo = exports.supportsDSS = exports.supportsLowLatency = exports.isMmwaveBand = exports.isSub6Band = exports.isValidNRNRCombination = exports.FREQ_5G5G_TEMPLATES = exports.HIGH_CAPACITY_NRDC_TEMPLATE = exports.DSS_NRDC_TEMPLATE = exports.URLLC_NRDC_TEMPLATE = exports.MMWAVE_INTEGRATION_TEMPLATE = exports.STANDARD_NRDC_TEMPLATE = exports.BEAM_MANAGEMENT_INTERFERENCE_SETTINGS = exports.NRNR_CAPACITY_SHARING = exports.MMWAVE_NRNR_HANDOVER = exports.URLLC_NRNR_HANDOVER = exports.STANDARD_NRNR_HANDOVER = exports.ADVANCED_NR_BANDS = void 0;
/**
 * Advanced 5G NR frequency bands including mmWave
 */
exports.ADVANCED_NR_BANDS = {
    78: {
        bandNumber: 78,
        frequencyRange: {
 ...
 */
exports.STANDARD_NRNR_HANDOVER = {
    triggerType: 'A3',
    hysteresis: 2,
    timeToTrigger: 160,
 ...
 */
exports.BEAM_MANAGEMENT_INTERFERENCE_SETTINGS = {
    enabled: true,
 ...
 */
function createBase5G5GRelation(relationId, referenceBand, relatedBand, priority = 70) {
    return {
        relationId,
 ...
 */
exports.STANDARD_NRDC_TEMPLATE = {
    ...
    templateType: '5G5G',
    priority: 70,
    baseConfig: createBase5G5GRelation('5G5G_STANDARD', exports.ADVANCED_NR_BANDS[78], exports.ADVANCED_NR_BANDS[41]),
    parameters: [
        {
            name: 'primaryNrBand',
            type: 'INTEGER',
 ...
 */
exports.MMWAVE_INTEGRATION_TEMPLATE = {
    ...
    templateType: '5G5G',
    priority: 70,
    baseConfig: Object.assign(createBase5G5GRelation('5G5G_MMWAVE', exports.ADVANCED_NR_BANDS[78], exports.ADVANCED_NR_BANDS[257]), {
        handoverConfig: exports.MMWAVE_NRNR_HANDOVER,
        nrdcConfig: {
            pCellConfig: {
                cellType: 'PCELL',
                servingCellPriority: 7,
...
exports.URLLC_NRDC_TEMPLATE = {
    ...
    templateType: '5G5G',
    priority: 70,
    baseConfig: Object.assign(createBase5G5GRelation('5G5G_URLLC', exports.ADVANCED_NR_BANDS[78], exports.ADVANCED_NR_BANDS[41]), {
        handoverConfig: exports.URLLC_NRNR_HANDOVER,
        capacitySharing: {
            enabled: true,
            strategy: 'PRIORITY_BASED',
...
exports.DSS_NRDC_TEMPLATE = {
    ...
    templateType: '5G5G',
    priority: 70,
    baseConfig: Object.assign(createBase5G5GRelation('5G5G_DSS', exports.ADVANCED_NR_BANDS[78], exports.ADVANCED_NR_BANDS[41]), {
        handoverConfig: exports.STANDARD_NRNR_HANDOVER,
        nrdcConfig: {
            pCellConfig: {
                cellType: 'PCELL',
                servingCellPriority: 7,
 ...
 */
exports.HIGH_CAPACITY_NRDC_TEMPLATE = {
    ...
    templateType: '5G5G',
    priority: 70,
    baseConfig: Object.assign(createBase5G5GRelation('5G5G_CAPACITY', exports.ADVANCED_NR_BANDS[78], exports.ADVANCED_NR_BANDS[77]), {
        handoverConfig: exports.STANDARD_NRNR_HANDOVER,
        capacitySharing: exports.NRNR_CAPACITY_SHARING,
        nrdcConfig: {
            pCellConfig: {
                cellType: 'PCELL',
                servingCellPriority: 7,
...
exports.areHighCapacityBands = areHighCapacityBands;
/**
 * Get maximum supported bandwidth for band combination
 */
function getMaxSupportedBandwidth(primaryBand, secondaryBand) {
    const bandWidths = {
...
exports.getMaxSupportedBandwidth = getMaxSupportedBandwidth;
/**
 * Calculate 5G5G frequency relation performance metrics
 */
function calculate5G5GMetrics(config) {
...
exports.calculate5G5GMetrics = calculate5G5GMetrics;
//# sourceMappingURL=freq-5g5g.js.map