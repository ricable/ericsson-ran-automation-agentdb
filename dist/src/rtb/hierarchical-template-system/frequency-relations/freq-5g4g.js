...
exports.calculate5G4GMetrics = exports.supportsQoS = exports.supportsHighMobility = exports.isLowFrequencyBand = exports.isCoverageBand = exports.isValid5G4GCombination = exports.FREQ_5G4G_TEMPLATES = exports.QOS_AWARE_5G4G_TEMPLATE = exports.MOBILITY_5G4G_TEMPLATE = exports.COVERAGE_5G4G_TEMPLATE = exports.EMERGENCY_5G4G_TEMPLATE = exports.STANDARD_5G4G_TEMPLATE = exports.FALLBACK_INTERFERENCE_SETTINGS = exports.SERVICE_CONTINUITY_CAPACITY_SHARING = exports.CONSERVATIVE_5G4G_HANDOVER = exports.AGGRESSIVE_5G4G_HANDOVER = exports.STANDARD_5G4G_HANDOVER = exports.FALLBACK_NR_BANDS = exports.FALLBACK_LTE_BANDS = void 0;
/**
 * LTE frequency bands for fallback scenarios
 */
exports.FALLBACK_LTE_BANDS = {
    1: {
        bandNumber: 1,
        frequencyRange: {
 ...
 */
exports.STANDARD_5G4G_HANDOVER = {
    triggerType: 'A2',
    hysteresis: 2,
    timeToTrigger: 320,
 ...
 */
exports.AGGRESSIVE_5G4G_HANDOVER = {
    triggerType: 'A2',
    hysteresis: 1,
    timeToTrigger: 160,
 ...
 */
exports.CONSERVATIVE_5G4G_HANDOVER = {
    triggerType: 'A2',
    hysteresis: 4,
    timeToTrigger: 640,
    cellIndividualOffset: 0,
 ...
 */
exports.SERVICE_CONTINUITY_CAPACITY_SHARING = {
    enabled: true,
 ...
 */
exports.FALLBACK_INTERFERENCE_SETTINGS = {
    enabled: false,
 ...
 */
function createBase5G4GRelation(relationId, referenceBand, relatedBand, priority = 80) {
    return {
        relationId,
 ...
 */
exports.STANDARD_5G4G_TEMPLATE = {
    ...
    templateType: '5G4G',
    priority: 80,
    baseConfig: createBase5G4GRelation('5G4G_STANDARD', exports.FALLBACK_NR_BANDS[78], exports.FALLBACK_LTE_BANDS[3]),
    parameters: [
        {
            name: 'nrBand',
            type: 'INTEGER',
 ...
 */
exports.EMERGENCY_5G4G_TEMPLATE = {
    ...
    templateType: '5G4G',
    priority: 80,
    baseConfig: Object.assign(createBase5G4GRelation('5G4G_EMERGENCY', exports.FALLBACK_NR_BANDS[78], exports.FALLBACK_LTE_BANDS[20]), {
        handoverConfig: exports.AGGRESSIVE_5G4G_HANDOVER,
        fallbackConfig: {
            fallbackTriggers: {
 ...
 */
exports.COVERAGE_5G4G_TEMPLATE = {
    ...
    templateType: '5G4G',
    priority: 80,
    baseConfig: Object.assign(createBase5G4GRelation('5G4G_COVERAGE', exports.FALLBACK_NR_BANDS[28], exports.FALLBACK_LTE_BANDS[20]), {
        handoverConfig: exports.CONSERVATIVE_5G4G_HANDOVER,
        fallbackConfig: {
            fallbackTriggers: {
 ...
 */
exports.MOBILITY_5G4G_TEMPLATE = {
    ...
    templateType: '5G4G',
    priority: 80,
    baseConfig: Object.assign(createBase5G4GRelation('5G4G_MOBILITY', exports.FALLBACK_NR_BANDS[78], exports.FALLBACK_LTE_BANDS[1]), {
        handoverConfig: exports.AGGRESSIVE_5G4G_HANDOVER,
        fallbackConfig: {
            fallbackTriggers: {
 ...
 */
exports.QOS_AWARE_5G4G_TEMPLATE = {
    ...
    templateType: '5G4G',
    priority: 80,
    baseConfig: Object.assign(createBase5G4GRelation('5G4G_QOS', exports.FALLBACK_NR_BANDS[78], exports.FALLBACK_LTE_BANDS[3]), {
        handoverConfig: exports.STANDARD_5G4G_HANDOVER,
        fallbackConfig: {
            fallbackTriggers: {
                nrCoverageThreshold: -118,
 ...
 */
function isValid5G4GCombination(nrBand, lteBand) {
    ...
    return validFallbackCombinations.some(combination => combination.nr === nrBand && combination.lte.includes(lteBand));
}
exports.isValid5G4GCombination = isValid5G4GCombination;
/**
 * Check if band is coverage band
 */
function isCoverageBand(band) {
    const coverageBands = [20, 28, 71];
    return coverageBands.includes(band);
}
exports.isCoverageBand = isCoverageBand;
/**
...
exports.calculate5G4GMetrics = calculate5G4GMetrics;
//# sourceMappingURL=freq-5g4g.js.map