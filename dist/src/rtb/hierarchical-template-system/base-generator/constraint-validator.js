...
exports.TemplateConstraintValidator = void 0;
class TemplateConstraintValidator {
     ...
     */
    async validateTemplates(templates, xmlSchema) {
     ...
     * Validate template structure
     */
    validateTemplateStructure(template, errors, warnings) {
     ...
     */
    async validateParameterConstraints(parameter, errors, warnings) {
     ...
     */
    async validateConstraint(parameter, constraint) {
     ...
     * Validate configuration values
     */
    async validateConfiguration(template, errors, warnings) {
     ...
     */
    async validateConfigurationConstraints(configKey, configValue, errors, warnings) {
        if (!configValue.constraints)
            return;
     ...
     * Validate custom functions
     */
    validateCustomFunctions(template, errors, warnings) {
        if (!template.custom)
            return;
     ...
     */
    validateFunctionSyntax(func, errors, warnings) {
        if (!func.body)
            return;
     ...
     * Apply global constraints
     */
    async applyGlobalConstraints(template, errors, warnings) {
     ...
     */
    async validateGlobalConstraint(template, constraint, errors, warnings) {
     ...
     */
    async validateDependencies(parameters, errors, warnings) {
     ...
     */
    async validateDependency(dependency, parameters, errors, warnings) {
     ...
     */
    async validateCognitiveConstraints(template, errors, warnings) {
     ...
     */
    async validateCognitiveConfiguration(configuration, errors, warnings) {
     ...
     */
    async evaluateDependencyRule(dependency, sourceParam, targetParam) {
...
exports.TemplateConstraintValidator = TemplateConstraintValidator;
