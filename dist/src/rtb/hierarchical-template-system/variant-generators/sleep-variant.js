...
exports.SleepVariantGenerator = void 0;
const variant_generator_core_1 = require("../variant-generator-core");
class SleepVariantGenerator extends variant_generator_core_1.VariantGeneratorCore {
    constructor() {
        super();
        this.sleepOptimizations = [
     ...
     */
    generateSleepVariant(baseTemplateName, context, options = {}) {
        const sleepOptions = {
            ...options,
     ...
     */
    generateSleepScenarioVariants(baseTemplateName) {
        const scenarios = {
        ...
        Object.entries(scenarios).forEach(([scenarioName, context]) => {
            variants[scenarioName] = this.generateSleepVariant(baseTemplateName, context);
        });
        return variants;
    }
    /**
...
exports.SleepVariantGenerator = SleepVariantGenerator;
//# sourceMappingURL=sleep-variant.js.map