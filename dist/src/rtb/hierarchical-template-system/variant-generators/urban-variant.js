...
exports.UrbanVariantGenerator = void 0;
const variant_generator_core_1 = require("../variant-generator-core");
class UrbanVariantGenerator extends variant_generator_core_1.VariantGeneratorCore {
    constructor() {
        super();
        this.urbanOptimizations = [
     ...
     */
    generateUrbanVariant(baseTemplateName, context, options = {}) {
        const urbanOptions = {
            ...options,
     ...
     */
    generateUrbanScenarioVariants(baseTemplateName) {
        const scenarios = {
            financial_district: {
     ...
     */
    getUrbanRecommendations(context) {
...
exports.UrbanVariantGenerator = UrbanVariantGenerator;
//# sourceMappingURL=urban-variant.js.map