...
class FrequencyRelationManager {
     ...
     */
    async generate4G4GRelation(config) {
        const template = {
            meta: {
                ...
                priority: interfaces_1.TemplatePriority.FREQUENCY_4G4G,
     ...
     */
    async generate4G5GRelation(config) {
        const template = {
            meta: {
                ...
                priority: interfaces_1.TemplatePriority.FREQUENCY_4G5G,
                frequencyBand: config.sourceBand,
     ...
     */
    async generate5G5GRelation(config) {
        const template = {
            meta: {
                ...
                priority: interfaces_1.TemplatePriority.FREQUENCY_5G5G,
                frequencyBand: config.sourceBand,
     ...
     */
    async generate5G4GRelation(config) {
        const template = {
            meta: {
                ...
                priority: interfaces_1.TemplatePriority.FREQUENCY_5G4G,
                frequencyBand: config.sourceBand,
     ...
     */
    generate4G4GConfiguration(config) {
        const baseConfig = {
            ...config.parameters,
     ...
     */
    generate4G4GEvaluations(config) {
        return {
            'optimal_offset': {
     ...
     */
    generate4G4GValidationRules(config) {
        return [
            {
     ...
     */
    generate4G5GConfiguration(config) {
        const baseConfig = {
            ...config.parameters,
        ...
        const endcConfig = {
            ...
            'NRCellRelation.ssbSubcarrierSpacing': 30,
     ...
     */
    generate4G5GEvaluations(config) {
        return {
     ...
     */
    generate4G5GValidationRules(config) {
        return [
            {
     ...
     */
    generate5G5GConfiguration(config) {
        const baseConfig = {
            ...config.parameters,
            'NRCellRelation.isNrNrDcEnabled': true,
            'NRCellRelation.dcCarrierType': 'SCG',
     ...
     */
    generate5G5GEvaluations(config) {
        return {
            'nrdc_capacity_gain': {
     ...
     */
    generate5G5GValidationRules(config) {
        return [
            {
     ...
     */
    generate5G4GConfiguration(config) {
        const baseConfig = {
            ...config.parameters,
            'NRCellRelation.isFallbackToLTE': true,
            'NRCellRelation.fallbackTriggerType': 'SIGNAL_QUALITY',
            'NRCellRelation.fallbackThreshold': -110,
            'NRCellRelation.fallbackHysteresis': 2,
    ...
    generate5G4GConditions(config) {
        return {
            ...
            'interference_scenario': {
                ...
                then: {
                    'NRCellRelation.fallbackThreshold': -105,
     ...
     */
    generate5G4GEvaluations(config) {
        return {
     ...
     */
    generate5G4GValidationRules(config) {
        return [
            {
    ...
    initializeCompatibilityMatrix() {
        ...
        const recommendations = [
            {
                sourceBand: interfaces_1.FrequencyBand.LTE_1800,
                targetBand: interfaces_1.FrequencyBand.NR_3500,
                recommendation: 'recommended',
                reason: 'Optimal EN-DC pairing with good coverage and capacity balance',
                useCase: ['urban', 'suburban', 'high_capacity']
            },
            {
                sourceBand: interfaces_1.FrequencyBand.LTE_2100,
                targetBand: interfaces_1.FrequencyBand.NR_3500,
                recommendation: 'recommended',
        ...
        const constraints = [
            {
                bands: [interfaces_1.FrequencyBand.LTE_800, interfaces_1.FrequencyBand.NR_3500],
                constraint: 'guard_band_required',
                parameters: { 'guardBandSize': 10 },
     ...
     */
    get4G4GBandParameters(sourceBand, targetBand) {
        const bandParams = {
            'lte_800-lte_1800': {
     ...
     */
    map4G4GHandoverParameters(params) {
        return {
     ...
     */
    map4G4GCapacityParameters(params) {
        return {
