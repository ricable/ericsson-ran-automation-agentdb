...
exports.VendorCompatibilityEngine = void 0;
class VendorCompatibilityEngine {
    constructor() {
     ...
     */
    translateCommand(command, targetVendor, context) {
        ...
        const translatedParameters = this.translateParameters(command.parameters || {}, sourceVendor, targetVendor, context);
        // Translate command options
        const translatedOptions = this.translateCommandOptions(command.options || {}, sourceVendor, targetVendor);
        ...
        const translatedCommand = {
            ...
            command: this.buildTranslatedCommandString(command.type, translatedFDN.path, translatedParameters.parameters, translatedOptions, targetVendor),
            context: {
                ...command.context,
                networkContext: {
     ...
     */
    validateVendorCompatibility(command, targetVendors, context) {
        const sourceVendor = context.networkContext.vendor.primary;
        const results = [];
     ...
     */
    generateVendorTemplates(commandType, targetMO, targetVendors, context) {
        const templates = [];
     ...
     */
    getVendorParameterRecommendations(moClass, parameters, targetVendor, context) {
     ...
     */
    translateVendorFeatures(features, sourceVendor, targetVendor) {
        const sourceConfig = this.vendorConfigs.get(sourceVendor);
        const targetConfig = this.vendorConfigs.get(targetVendor);
     ...
     */
    translateFDNPath(fdnPath, sourceVendor, targetVendor) {
        const warnings = [];
        const sourceConfig = this.vendorConfigs.get(sourceVendor);
        const targetConfig = this.vendorConfigs.get(targetVendor);
     ...
     */
    translateParameters(parameters, sourceVendor, targetVendor, context) {
        const warnings = [];
        ...
        for (const [paramName, paramValue] of Object.entries(parameters)) {
            ...
            if (mapping) {
                const targetParamName = mapping[targetVendor];
                if (targetParamName && targetParamName !== paramName) {
                    translatedParameters[targetParamName] = this.convertParameterValue(paramValue, mapping, sourceVendor, targetVendor);
                }
                else {
     ...
     */
    convertParameterValue(value, mapping, sourceVendor, targetVendor) {
     ...
     */
    mapEnumValue(value, enumValues, sourceVendor, targetVendor) {
     ...
     * Translate command options
     */
    translateCommandOptions(options, sourceVendor, targetVendor) {
     ...
     */
    buildTranslatedCommandString(commandType, targetPath, parameters, options, targetVendor) {
     ...
     */
    calculateCompatibilityScore(sourceVendor, targetVendor, command) {
     ...
     */
    assessCommandComplexity(command) {
        let complexity = 1;
     ...
     */
    assessParameterCompatibility(command, sourceVendor, targetVendor) {
     ...
     */
    assessVendorCompatibility(command, sourceVendor, targetVendor, context) {
        const compatibilityScore = this.calculateCompatibilityScore(sourceVendor, targetVendor, command);
        const issues = [];
        const features = [];
        ...
        if (command.parameters) {
            for (const [paramName] of Object.entries(command.parameters)) {
                ...
                if (mapping && !mapping[targetVendor]) {
                    issues.push({
     ...
     */
    generateCompatibilityRecommendations(results, overallCompatibility) {
        const recommendations = [];
        ...
        const mostCompatible = results.reduce((best, current) => current.compatibility.compatibilityScore > best.compatibility.compatibilityScore ? current : best);
     ...
     */
    translateMOClassPath(moClass, sourceVendor, targetVendor) {
        const targetConfig = this.vendorConfigs.get(targetVendor);
     ...
     */
    getParameterMappingsForMO(moClass, sourceVendor, targetVendor) {
     ...
     */
    validateVendorParameter(mapping, value, vendor) {
     ...
     */
    identifyVendorOptimization(mapping, value, vendor, context) {
     ...
     */
    calculateBaseCompatibilityScore(source, target) {
    ...
    getHuaweiParameterMapping() {
        return this.getEricssonParameterMapping(); // Placeholder
    }
    getHuaweiCommandMapping() {
        return this.getEricssonCommandMapping(); // Placeholder
    }
    getHuaweiMOClassMapping() {
        return this.getEricssonMOClassMapping(); // Placeholder
    }
    getHuaweiFeatureMapping() {
        return this.getEricssonFeatureMapping(); // Placeholder
    }
    getNokiaParameterMapping() {
        return this.getEricssonParameterMapping(); // Placeholder
    }
    getNokiaCommandMapping() {
        return this.getEricssonCommandMapping(); // Placeholder
    }
    getNokiaMOClassMapping() {
        return this.getEricssonMOClassMapping(); // Placeholder
    }
    getNokiaFeatureMapping() {
        return this.getEricssonFeatureMapping(); // Placeholder
    }
    getSamsungParameterMapping() {
        return this.getEricssonParameterMapping(); // Placeholder
    }
    getSamsungCommandMapping() {
        return this.getEricssonCommandMapping(); // Placeholder
    }
    getSamsungMOClassMapping() {
        return this.getEricssonMOClassMapping(); // Placeholder
    }
    getSamsungFeatureMapping() {
        return this.getEricssonFeatureMapping(); // Placeholder
    }
    getZTEParameterMapping() {
        return this.getEricssonParameterMapping(); // Placeholder
    }
    getZTECommandMapping() {
        return this.getEricssonCommandMapping(); // Placeholder
    }
    getZTEMOClassMapping() {
        return this.getEricssonMOClassMapping(); // Placeholder
    }
    getZTEFeatureMapping() {
        return this.getEricssonFeatureMapping(); // Placeholder
    }
}
exports.VendorCompatibilityEngine = VendorCompatibilityEngine;
//# sourceMappingURL=vendor-compatibility.js.map