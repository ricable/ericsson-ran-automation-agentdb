...
exports.ReservedByParser = void 0;
const fs_1 = require("fs");
class ReservedByParser {
    constructor() {
        this.hierarchy = {
    ...
    createConstraintValidator(relationship) {
    ...
    getDependencyChain(className, visited = new Set()) {
    ...
    getCardinalityConstraints(sourceClass, targetClass) {
    ...
    validateRelationship(sourceClass, targetClass, instanceCount) {
        const errors = [];
        const key = `${sourceClass}.${targetClass}`;
...
exports.ReservedByParser = ReservedByParser;
//# sourceMappingURL=reservedby-parser.js.map