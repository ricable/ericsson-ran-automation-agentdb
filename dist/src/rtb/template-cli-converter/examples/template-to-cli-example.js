...
exports.runAllExamples = exports.example5_PerformanceOptimized = exports.example4_SafeConversion = exports.example3_BatchConversion = exports.example2_IntegratedConversion = exports.example1_BasicConversion = void 0;
...
exports.example1_BasicConversion = example1_BasicConversion;
/**
 * Example 2: Integrated conversion with inheritance
 */
async function example2_IntegratedConversion() {
    console.log('\n=== Example 2: Integrated Conversion with Template Inheritance ===');
    try {
        // Create template system
        const templateSystem = new hierarchical_template_system_1.IntegratedTemplateSystem();
        // Create integration
        const integration = new integration_1.RtbTemplateIntegration(templateSystem, {
        ...
        const result = await integration.convertTemplateWithInheritance(EXAMPLE_LTE_TEMPLATE, EXAMPLE_CONTEXT, {
...
exports.example2_IntegratedConversion = example2_IntegratedConversion;
/**
 * Example 3: Batch conversion of multiple templates
 */
async function example3_BatchConversion() {
    console.log('\n=== Example 3: Batch Conversion of Multiple Templates ===');
    try {
        ...
        const templates = [
            EXAMPLE_LTE_TEMPLATE,
            {
                ...
                configuration: {
                    ...
                    'EUtranCellFDD.referenceSignalPower': 18,
            ...
            },
            {
                ...
                configuration: {
                    ...EXAMPLE_LTE_TEMPLATE.configuration,
                    'EUtranCellFDD.referenceSignalPower': 12,
        ...
        const results = await integration.convertTemplatesBatch(templates, EXAMPLE_CONTEXT, {
...
exports.example3_BatchConversion = example3_BatchConversion;
/**
 * Example 4: Safe conversion with preview and rollback
 */
async function example4_SafeConversion() {
    console.log('\n=== Example 4: Safe Conversion with Preview and Rollback ===');
    try {
        // Create converter with safe configuration
        const converter = new index_1.TemplateToCliConverter(index_1.SAFE_CONFIG);
...
exports.example5_PerformanceOptimized = example5_PerformanceOptimized;
/**
 * Create a large template with many cell configurations
 */
function createLargeCellTemplate(cellCount) {
    const configuration = {};
...
//# sourceMappingURL=template-to-cli-example.js.map