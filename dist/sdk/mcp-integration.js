...
const flow_nexus_1 = require("flow-nexus");
...
class MCPIntegrationManager {
    ...
    async initializeRUVSwarm() {
        const startTime = Date.now();
        try {
            const result = await (0, ruv_swarm_1.mcp__ruv_swarm__swarm_init)({
    ...
    async executeFlowNexusTask(task) {
        ...
        try {
            ...
            const deployment = await (0, flow_nexus_1.mcp__flow_nexus__template_deploy)({
    ...
    async executeRUVSwarmTask(task) {
        ...
        try {
            ...
            const result = await (0, ruv_swarm_1.mcp__ruv_swarm__agents_spawn_parallel)({
                agents: task.agents || [
                    {
                        type: 'researcher',
    ...
    async authenticateFlowNexus() {
        try {
            ...
            await (0, flow_nexus_1.mcp__flow_nexus__user_login)({ email, password });
    ...
    async manageFlowNexusCredits() {
        try {
            const balance = await (0, flow_nexus_1.mcp__flow_nexus__check_balance)();
    ...
    async createFlowNexusSandbox() {
        try {
            return await (0, flow_nexus_1.mcp__flow_nexus__sandbox_create)({
