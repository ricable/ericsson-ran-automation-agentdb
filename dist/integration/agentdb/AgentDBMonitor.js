...
exports.AgentDBMonitor = void 0;
const events_1 = require("events");
class AgentDBMonitor extends events_1.EventEmitter {
    constructor() {
        super();
        this.metrics = [];
        this.quicMetrics = new Map();
        this.vectorMetrics = new Map();
        this.syncMetrics = new Map();
        this.monitoringInterval = null;
        this.monitoringIntervalMs = 500; // 500ms for sub-second monitoring
        this.maxMetricsHistory = 2000;
        // Performance thresholds
        this.thresholds = {
            vectorSearchLatency: 1.0,
            quicSyncLatency: 1.0,
            queryThroughput: 1000,
     ...
     */
    checkQUICSyncHealth(metrics) {
        const quicLatencies = this.quicMetrics.get('latency') || [];
        if (quicLatencies.length < 10)
            return;
     ...
     */
    calculateQUICHealthScore(latencies) {
        if (latencies.length === 0)
            return 0;
     ...
     */
    calculateVectorSearchScore(latencies) {
        if (latencies.length === 0)
            return 0;
        const avgLatency = latencies.reduce((sum, lat) => sum + lat, 0) / latencies.length;
...
exports.AgentDBMonitor = AgentDBMonitor;
//# sourceMappingURL=AgentDBMonitor.js.map