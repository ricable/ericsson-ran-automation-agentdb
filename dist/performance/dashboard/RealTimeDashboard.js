...
class RealTimeDashboard extends events_1.EventEmitter {
    constructor() {
        super();
        this.updateInterval = null;
        this.updateIntervalMs = 1000; // 1 second for <1s updates
     ...
     */
    generateAlertMessage(component, severity) {
        const messages = {
            'Cognitive Core': {
